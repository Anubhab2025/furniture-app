  ...
  return (
    <div className="p-6 md:p-8 lg:p-10 min-h-screen bg-gradient-to-br from-slate-50 to-slate-100">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="md:hidden max-h-[60vh] overflow-y-auto pr-2">
      ...
      {selectedQuotation && (
        ...
        >
          <div
            className="bg-white/95 backdrop-blur-lg rounded-3xl shadow-2xl w-full max-w-5xl max-h-[80vh] md:max-h-[90vh] overflow-y-auto"
