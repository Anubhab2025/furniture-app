  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed top-4 left-4 z-50 p-2 bg-white/90 backdrop-blur-sm rounded-lg shadow-lg border border-white/20 md:hidden"
      >
        {mobileOpen ? (
      ...
      <aside
        className={`
          fixed inset-y-0 left-0 z-50 w-64 flex flex-col bg-white/80 backdrop-blur-sm border-r border-white/20 shadow-lg
      ...
      >
        <div className="flex flex-col h-full overflow-hidden">
          ...
          {/* Logout */}
          <div className="border-t border-gray-100 px-3 pb-6 pt-4 mt-auto">
            <button
              onClick={() => {
                logout();
                close();
